...
export default function UploadButton() {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-b-md mb-6 border-b border-gray-100">
        ...
        <div className="relative">
          ...
          {!preview ? (
            <div 
              ...
              className="border-2 border-dashed border-gray-200 rounded-md p-8 text-center cursor-pointer bg-white/80"
            >
