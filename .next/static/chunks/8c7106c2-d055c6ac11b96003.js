"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[978],{9247:function(e,t,r){r.d(t,{ET:function(){return addDoc},IO:function(){return query},PL:function(){return getDocs},Xo:function(){return orderBy},ad:function(){return getFirestore},cf:function(){return onSnapshot},hJ:function(){return collection}});var n,i,s,a,o=r(2238),l=r(8463),u=r(3333),c=r(4444),_=r(3042),h=r(483);r(3454);var d=r(1876).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let P=new SortedMap(DocumentKey.comparator),A=new SortedMap(DocumentKey.comparator);function documentMap(...e){let t=A;for(let r of e)t=t.insert(r.key,r);return t}function __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e){let t=A;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function __PRIVATE_newDocumentKeyMap(){return new ObjectMap(e=>e.toString(),(e,t)=>e.isEqual(t))}let y=new SortedMap(DocumentKey.comparator),R=new SortedSet(DocumentKey.comparator);function __PRIVATE_documentKeySet(...e){let t=R;for(let r of e)t=t.add(r);return t}let V=new SortedSet(__PRIVATE_primitiveComparator);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
